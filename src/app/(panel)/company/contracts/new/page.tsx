...
import { useContract } from "@/features/contracts";
...
export default function NewContractPage() {
  ...
  const parseError = (error: any, fallback = "Unexpected error") => {
    ...
    <div style={{ padding: 20 }}>
      ...
      {step === "event" && (
        <>
          ...
          >
            <strong>ℹ️ Información sobre el formato de fecha</strong>
            ...
            >
              Al crear el evento, las fechas se ingresan usando el formato
              inglés:
      ...
      {step === "services" && contractId && (
        <>
          ...
          >
              ...
              onSubmit={async (data) => {
                try {
                  ...
                  if (!res.ok) {
                    ...
                    setError(
                      parseError(result?.error, "Failed to add service"),
                    );
              ...
              onDelete={async (id) => {
                ...
                try {
                  ...
                  if (!res.ok) {
                    ...
                    setError(parseError(data?.error, "Failed to delete"));
              ...
              onUpdate={async (id, data) => {
                try {
                  ...
                  if (!res.ok) {
                    ...
                    setError(parseError(result?.error, "Failed to update"));
            ...
            <p>
              ⚠️ Despues de agregar un pago a un servicio, se concidera iniciado
              el contrato ⚠️
            </p>
            <p>⚠️ Siendo este es el paso final de el registro rapido ⚠️</p>
            <p>
              ℹ️ si deseas continuar con un registro nuevo refrezca la pagina 🔄
            </p>
            <p>ℹ️ o darle click al boton de abajo ⬇️</p>
          </div>
          <button
            onClick={resetAll}
            style={{
